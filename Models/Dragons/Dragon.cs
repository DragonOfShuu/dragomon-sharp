...
public class Dragon(
    ...
    List<AttackPattern>? attacks = null
) : Entity(startingHealth, maxHealth, element), IEditableItem
{
    public string Name { get; private set; } = name;
    public string? Nickname { get; set; }
    public int Level { get; private set; } = level;
    public bool IsFavorite { get; set; }
    public List<AttackPattern> Attacks { get; private set; } = attacks ?? [];
    public DragonProperties? Properties { get; private set; } = properties;
    ...
    string IEditableItem.Description =>
        $"Element: {Element?.EntityElement.ToString() ?? "None"}\nHealth: {Health}/{MaxHealth}";
